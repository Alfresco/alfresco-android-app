...
public final class HistorySearchSchema
{
    ...
    public static final String[] COLUMN_ALL = { COLUMN_ID, COLUMN_ACCOUNT_ID, COLUMN_TYPE, COLUMN_ADVANCED,
            COLUMN_DESCRIPTION, COLUMN_QUERY, COLUMN_LAST_REQUEST_TIMESTAMP };

    private static final String QUERY_TABLE_CREATE = "create table " + TABLENAME + " (" + COLUMN_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_ACCOUNT_ID + " INTEGER NOT NULL," + COLUMN_ADVANCED
            + " INTEGER NOT NULL," + COLUMN_TYPE + " INTEGER NOT NULL," + COLUMN_DESCRIPTION + " TEXT NOT NULL,"
            + COLUMN_QUERY + " TEXT," + COLUMN_LAST_REQUEST_TIMESTAMP + " LONG NOT NULL" + ");";
