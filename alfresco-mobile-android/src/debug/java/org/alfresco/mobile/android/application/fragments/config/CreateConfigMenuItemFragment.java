...
public class CreateConfigMenuItemFragment extends AlfrescoFragment
{
    ...
    private void displayParameters()
    {
        ...
        for (ConfigParameterModel param : selectedConfigType.getParameters())
        {
            ...
            {
                vr.setPrimaryColor(R.color.alfresco_tangerine);
                vr.setBaseColor(R.color.alfresco_tangerine);
                vr.setMetTextColor(R.color.alfresco_tangerine);
                vr.setUnderlineColor(R.color.alfresco_tangerine);
            }
