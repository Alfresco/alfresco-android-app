 ...
 */
public class MimeTypeProvider extends ContentProvider implements AlfrescoContentProvider
{
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs)
    {
        ...
        switch (uriType)
        {
            ...
            case MIMETYPE_ID:
                ...
                {
                    rowsDeleted = db.delete(MimeTypeSchema.TABLENAME, MimeTypeSchema.COLUMN_ID + "=" + id,
                            null);
                }
                else
                {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs)
    {
        ...
        switch (uriType)
        {
            ...
            case MIMETYPE_ID:
                ...
                if (TextUtils.isEmpty(selection))
                {
                    rowsUpdated = sqlDB.update(MimeTypeSchema.TABLENAME, values, MimeTypeSchema.COLUMN_ID
                            + "=" + id, null);
                }
                else
                {
