...
/**
 * UploadService is responsible to upload document from the device to the repository.
 * 
 * @author Jean Marie Pascal
 */
public class DeleteFileCallback extends AbstractBatchOperationCallback<Void>
{
    public DeleteFileCallback(Context context, int totalItems, int pendingItems)
    {
