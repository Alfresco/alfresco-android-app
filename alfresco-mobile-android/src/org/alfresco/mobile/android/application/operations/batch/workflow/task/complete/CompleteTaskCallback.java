...
public class CompleteTaskCallback extends AbstractBatchOperationCallback<Task>
{
    public CompleteTaskCallback(Context context, int totalItems, int pendingItems)
    {
