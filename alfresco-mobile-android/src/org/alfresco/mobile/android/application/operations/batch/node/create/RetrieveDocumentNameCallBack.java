...
public class RetrieveDocumentNameCallBack extends AbstractBatchOperationCallback<String>
{

    public RetrieveDocumentNameCallBack(Context context, int totalItems, int pendingItems)
    {
