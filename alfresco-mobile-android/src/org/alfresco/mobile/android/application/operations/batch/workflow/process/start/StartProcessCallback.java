...
public class StartProcessCallback extends AbstractBatchOperationCallback<Task>
{
    public StartProcessCallback(Context context, int totalItems, int pendingItems)
    {
