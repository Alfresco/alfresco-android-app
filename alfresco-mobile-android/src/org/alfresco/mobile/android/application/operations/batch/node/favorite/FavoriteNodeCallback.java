 ...
 */
public class FavoriteNodeCallback extends AbstractBatchOperationCallback<Boolean>
{
    public FavoriteNodeCallback(Context context, int totalItems, int pendingItems)
    {
       super(context, totalItems, pendingItems);
       inProgress = getBaseContext().getString(R.string.favorite_in_progress);
       complete = getBaseContext().getString(R.string.favorite_complete);
    }
}
