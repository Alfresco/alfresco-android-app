...
public class DecimalField extends BaseField
{
    ...
    // CONSTRUCTOR
    // ///////////////////////////////////////////////////////////////////////////
    public DecimalField(Context context, Property property, FieldConfig configuration)
    {
    ...
    public View getEditView(ModelDefinition typeDefinition, ViewGroup hookView)
    {
        ...
        v.getEditText().setInputType(EditorInfo.TYPE_CLASS_NUMBER|EditorInfo.TYPE_NUMBER_FLAG_DECIMAL|EditorInfo.TYPE_NUMBER_FLAG_SIGNED);
        return v;
    }
    ...
    {
        String value = ((EditTextFieldView) fieldView).getText();
