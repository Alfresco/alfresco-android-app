 ...
 */
public class ImportLocalDialogFragment extends DialogFragment
{
    ...
    public static ImportLocalDialogFragment newInstance(Account account, File f)
    {
        ImportLocalDialogFragment fragment = new ImportLocalDialogFragment();
        Bundle b = new Bundle();
    ...
    public static ImportLocalDialogFragment newInstance(Bundle bundle)
    {
        ImportLocalDialogFragment fragment = new ImportLocalDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        File f = StorageManager.getDownloadFolder(getActivity(), currentAccount.getUrl(), currentAccount.getUsername());
