...
public class CreateDirectoryDialogFragment extends DialogFragment
{
    ...
    public static final String TAG = CreateDirectoryDialogFragment.class.getName();
    ...
    {
        CreateDirectoryDialogFragment adf = new CreateDirectoryDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        button.setOnClickListener(new OnClickListener()
        {
            ...
            {
                CreateDirectoryDialogFragment.this.dismiss();
            }
        });
