...
public class DisableSyncDialogFragment extends DialogFragment
{
    public static final String TAG = DisableSyncDialogFragment.class.getName();

    private OnFavoriteChangeListener onFavoriteChangeListener;

    public DisableSyncDialogFragment()
    {
    }

    public static DisableSyncDialogFragment newInstance(OnFavoriteChangeListener listener)
    {
        DisableSyncDialogFragment frag = new DisableSyncDialogFragment();
