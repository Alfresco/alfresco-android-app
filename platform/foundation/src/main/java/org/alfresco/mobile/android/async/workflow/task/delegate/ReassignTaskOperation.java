...
public class ReassignTaskOperation extends TaskOperation<Task>
{
    ...
    protected void onPostExecute(LoaderResult<Task> result)
    {
        ...
        AnalyticsHelper.reportOperationEvent(context, AnalyticsManager.CATEGORY_BPM, AnalyticsManager.ACTION_REASSIGN,
                updatedTask != null ? updatedTask.getKey() : null, 1, result.hasException());
