...
public class DataProtectionManager extends Manager
{
    ...
    {
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(appContext);
        sharedPref.edit().putBoolean(DATA_PROTECTION_ENABLE, isEnabled).apply();
    }
    ...
    {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(appContext);
        prefs.edit().putString(REQUIRES_ENCRYPT, file.getPath()).apply();
    }
    ...
    {
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(appContext);
        sharedPref.edit().putBoolean(DATA_PROTECTION_USER_REQUEST, isRequested).apply();
    }
}
