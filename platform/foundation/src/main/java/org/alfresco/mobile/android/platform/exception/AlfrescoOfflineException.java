...
public class AlfrescoOfflineException extends AlfrescoAppException
{
     ...
     */
    public AlfrescoOfflineException(String detailsMessage)
    {
     ...
     */
    public AlfrescoOfflineException(String message, boolean displayMessage)
    {
        super(message);
     ...
     */
    public AlfrescoOfflineException(int errorCode, Throwable e)
    {
        super(errorCode, e);
    }
