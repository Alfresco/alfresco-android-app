...
public class AvatarRequest extends BaseOperationRequest
{
    ...
    public static final int TYPE_ID = OperationRequestIds.ID_AVATAR_READ;
    ...
    // CONSTRUCTORS
    // ///////////////////////////////////////////////////////////////////////////
    protected AvatarRequest(Context context, long accountId, String networkId, int notificationVisibility,
    ...
    public static class Builder extends ListingOperationRequest.Builder
    {
        ...
        {
            return new AvatarRequest(context, accountId, networkId, notificationVisibility, title, mimeType,
