...
public class Text
{
     ...
     *             is not supported by the MessageDigest class.
     ...
     * @param newString new substring to replace occurrences of
     *            <code>oldString</code>
     * @return a string
     */
    public static String replace(String text, String oldString, String newString)
    {
        if (text == null || oldString == null || newString == null) { throw new IllegalArgumentException(
                "null argument"); }
    ...
    /**
     * Replaces illegal XML characters in the given string by their
     * corresponding predefined entity references.
     *
    ...
    {
        if (text == null) { throw new IllegalArgumentException("null argument"); }
     ...
     *             character do not represent a hex-number or if not enough
    ...
    public static String unescape(String string, char escape)
    {
        try
        {
            ...
            if ((utf8.length >= 1 && utf8[utf8.length - 1] == escape)
                    || (utf8.length >= 2 && utf8[utf8.length - 2] == escape)) { throw new IllegalArgumentException(
                    "Premature end of escape sequence at end of input"); }
     ...
     * @see <a
     *      href="https://issues.apache.org/jira/browse/JCR-3128">JCR-3128</a>
     * @param name the name to escape
     * @return the escaped name
     */
     ...
     * method does not validate the name or prefix. </p> the qname has the
     * format: qname := [prefix ':'] local;
     *
     ...
     * this method does not validate the name. </p> the qname has the format:
     * qname := [prefix ':'] local;
     *
     * @param qname a qualified name
