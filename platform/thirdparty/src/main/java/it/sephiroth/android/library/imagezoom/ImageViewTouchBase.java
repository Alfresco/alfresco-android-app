...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable
{
     ...
     * {@link it.sephiroth.android.library.imagezoom.ImageViewTouchBase#setDisplayType(it.sephiroth.android.library.imagezoom.ImageViewTouchBase.DisplayType)}
     * of this View
     * 
     * @author alessandro
     */
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom)
    {
        ...
        if (LOG_ENABLED)
        {
            Log.e(LOG_TAG, "onLayout: " + changed + ", bitmapChanged: " + mBitmapChanged + ", scaleChanged: "
                    + mScaleTypeChanged);
        }
    ...
    /**
     * @see #setImageDrawable(android.graphics.drawable.Drawable,
     ...
     * @param min_zoom the optional minimum scale, pass {@link #ZOOM_INVALID} to
     *            use the default min_zoom
     * @param max_zoom the optional maximum scale, pass {@link #ZOOM_INVALID} to
     *            use the default max_zoom
     */
    public void setImageDrawable(final Drawable drawable, final Matrix initial_matrix, final float min_zoom,
     ...
     * {@link it.sephiroth.android.library.imagezoom.ImageViewTouchBase.DisplayType}
     * has been modified
     * 
     * @param left
     * @param top
     ...
     * {@link #setImageDrawable(android.graphics.drawable.Drawable, android.graphics.Matrix, float, float)}
     * to restore the same view state of the previous
     * {@link android.graphics.Bitmap}.<br />
     * Example:
     * 
     * <pre>
