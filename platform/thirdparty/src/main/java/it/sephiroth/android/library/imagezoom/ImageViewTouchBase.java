...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
	...
	/**
	 * Use this to change the {@link it.sephiroth.android.library.imagezoom.ImageViewTouchBase#setDisplayType(it.sephiroth.android.library.imagezoom.ImageViewTouchBase.DisplayType)} of
	 * this View
	 * @author alessandro
	 *
	 */
	 ...
	 * or the {@link it.sephiroth.android.library.imagezoom.ImageViewTouchBase.DisplayType} has been modified
	 * 
	 * @param left
	 * @param top
	 * @param right
