...
public class SmoothProgressDrawable extends Drawable implements Animatable
{
    ...
    {
        if (colors == null || colors.length == 0) throw new IllegalArgumentException("Colors cannot be null or empty");
        mColorsIndex = 0;
        mColors = colors;
        invalidateSelf();
    }
    ...
    {
        if (index < 0 || index >= mColors.length) { throw new IllegalArgumentException(String.format(
    ...
    public static class Builder
    {
        ...
        public SmoothProgressDrawable build()
        {
            ...
            return new SmoothProgressDrawable(mInterpolator, mSectionsCount, mStrokeSeparatorLength, mColors,
                    mStrokeWidth, mSpeed, mProgressiveStartSpeed, mProgressiveStopSpeed, mReversed, mMirrorMode,
                    mOnProgressiveStopEndedListener, mProgressiveStartActivated, mBackgroundDrawableWhenHidden);
        }
        ...
        {
            if (interpolator == null) throw new IllegalArgumentException("Interpolator can't be null");
            mInterpolator = interpolator;
            return this;
        }
        ...
        {
            if (progressiveStartSpeed < 0) throw new IllegalArgumentException("progressiveStartSpeed must be >= 0");
            mProgressiveStartSpeed = progressiveStartSpeed;
            return this;
        }
        ...
        {
            if (progressiveStopSpeed < 0) throw new IllegalArgumentException("progressiveStopSpeed must be >= 0");
            mProgressiveStopSpeed = progressiveStopSpeed;
            return this;
        }
