...
public class SamsungManagerImpl extends SamsungManager
{
    ...
    public boolean hasPenEnable()
    {
        try
        {
            ...
            spenPackage.initialize(appContext);
        ...
        catch (SsdkUnsupportedException e)
        {
            ...
            else if (eType == SsdkUnsupportedException.LIBRARY_UPDATE_IS_RECOMMENDED) { return true; }
        }
        catch (Exception e1)
        {
        }
    ...
    {
        return new DocumentTypeRecord(R.drawable.mime_pages, R.string.create_samsung_note, SAMSUNG_NOTE_EXTENSION,
                "application/samsung_note", null);
    }
}
