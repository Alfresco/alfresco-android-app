...
public class CommentsRequest extends ListingOperationRequest
{
    private static final long serialVersionUID = 1L;

    public static final int TYPE_ID = OperationRequestIds.ID_COMMENT_LIST;
    ...
    // CONSTRUCTORS
    // ///////////////////////////////////////////////////////////////////////////
    protected CommentsRequest(Context context, long accountId, String networkId, int notificationVisibility,
    ...
    {
        return CommentsRequest.class.getName();
    }
    ...
    public static class Builder extends ListingOperationRequest.Builder
    {
        ...
        public CommentsRequest build(Context context)
        {
            return new CommentsRequest(context, accountId, networkId, notificationVisibility, title, mimeType,
