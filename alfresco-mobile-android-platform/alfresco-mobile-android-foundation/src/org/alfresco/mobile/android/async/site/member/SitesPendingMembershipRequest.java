...
public class SitesPendingMembershipRequest extends ListingOperationRequest
{
    ...
    public static final int TYPE_ID = OperationRequestIds.ID_SITE_MEMBERSHIP_LIST;

    // ///////////////////////////////////////////////////////////////////////////
    // CONSTRUCTORS
    // ///////////////////////////////////////////////////////////////////////////
    protected SitesPendingMembershipRequest(Context context, long accountId, String networkId,
            int notificationVisibility, String title, String mimeType, int requestTypeId)
    {
        super(context, accountId, networkId, notificationVisibility, title, mimeType, requestTypeId, null);
    }
    ...
    public static class Builder extends ListingOperationRequest.Builder
    {
        ...
        {
            return new SitesPendingMembershipRequest(context, accountId, networkId, notificationVisibility, title,
                    mimeType, requestTypeId);
        }
    }
}
