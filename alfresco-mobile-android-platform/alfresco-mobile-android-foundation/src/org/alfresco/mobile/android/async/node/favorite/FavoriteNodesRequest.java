...
public class FavoriteNodesRequest extends ListingOperationRequest
{
    ...
    public static final int TYPE_ID = OperationRequestIds.ID_FAVORITE_NODE_BROWSE;
    ...
    // CONSTRUCTORS
    // ///////////////////////////////////////////////////////////////////////////
    protected FavoriteNodesRequest(Context context, long accountId, String networkId, int notificationVisibility,
    ...
    public static class Builder extends ListingOperationRequest.Builder
    {
        ...
        public Builder(ListingContext lc)
        {
            this();
            this.listingContext = lc;
        }

        public FavoriteNodesRequest build(Context context)
        {
            return new FavoriteNodesRequest(context, accountId, networkId, notificationVisibility, title, mimeType,
