...
public abstract class OperationsSchema
{
    ...
    // LIFECYCLE
    // ////////////////////////////////////////////////////
    protected static final String[] COLUMNS = { COLUMN_ID, COLUMN_ACCOUNT_ID, COLUMN_TENANT_ID, COLUMN_STATUS,
            COLUMN_REASON, COLUMN_REQUEST_TYPE, COLUMN_TITLE, COLUMN_NOTIFICATION_VISIBILITY, COLUMN_NODE_ID,
            COLUMN_PARENT_ID, COLUMN_MIMETYPE, COLUMN_PROPERTIES, COLUMN_TOTAL_SIZE_BYTES,
            COLUMN_BYTES_DOWNLOADED_SO_FAR, COLUMN_LOCAL_URI };

    protected static final String QUERY_CREATE_COLUMNS = COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
            + COLUMN_ACCOUNT_ID + " LONG," + COLUMN_TENANT_ID + " TEXT," + COLUMN_STATUS + " INTEGER," + COLUMN_REASON
            + " INTEGER," + COLUMN_REQUEST_TYPE + " INTEGER," + COLUMN_TITLE + " TEXT,"
            + COLUMN_NOTIFICATION_VISIBILITY + " INTEGER," + COLUMN_NODE_ID + " TEXT," + COLUMN_PARENT_ID + " TEXT,"
            + COLUMN_MIMETYPE + " TEXT," + COLUMN_PROPERTIES + " TEXT," + COLUMN_TOTAL_SIZE_BYTES + " LONG,"
            + COLUMN_BYTES_DOWNLOADED_SO_FAR + " LONG," + COLUMN_LOCAL_URI + " TEXT";
