...
public class CloudSignupRequest
{
    ...
    public CloudSignupRequest(AlfrescoAccount acc)
    {
    ...
    public static CloudSignupRequest signup(Context context, String firstName, String lastName, String emailAddress,
            String password, String apiKey)
    {
        UrlBuilder url = new UrlBuilder(getCloudSignupUrl(SessionManager.getInstance(context).getSignUpHostname()));
        ...
        // send and parse
        Response resp = NetworkHttpInvoker.invokePOST(url, formData.getContentType(), new Output()
        {
    ...
    public static boolean checkAccount(Context context, CloudSignupRequest signupRequest, String apiKey)
    {
        UrlBuilder url = new UrlBuilder(getVerifiedAccountUrl(signupRequest, SessionManager.getInstance(context)
                .getSignUpHostname()));
