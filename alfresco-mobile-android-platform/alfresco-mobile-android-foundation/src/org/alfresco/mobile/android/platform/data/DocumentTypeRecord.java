...
public class DocumentTypeRecord implements Serializable
{
    ...
    public DocumentTypeRecord(int iconId, int nameId, String extension, String mimetype, String template)
    {
        super();
        this.iconId = iconId;
        this.nameId = nameId;
    ...
    public DocumentTypeRecord(int iconId, String nameString, String extension, String mimetype, String template)
    {
        super();
        this.iconId = iconId;
